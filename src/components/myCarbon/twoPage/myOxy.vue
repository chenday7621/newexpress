<template>
<div class="main">
  <lottie :options="defaultOptions" style="height:25vh;width:25vh"  @animCreated="handleAnimation" />
</div>
</template>

<script>
import lottie from 'vue-lottie'
import * as animationData from '@/assets/js/animOxy.json'
export default {
  name: "myOxy",
  components:{
    lottie
  ...
  setup(){
    ...
    return{
      defaultOptions,handleAnimation
    }
  }
};
</script>
